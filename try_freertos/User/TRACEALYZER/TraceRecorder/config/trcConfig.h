...
#define TRC_CFG_RECORDER_MODE TRC_RECORDER_MODE_STREAMING       // 选择追踪模式（默认快照模式，这里我改成
/**
...
#define TRC_CFG_FREERTOS_VERSION    TRC_FREERTOS_VERSION_9_0_0                // 这里根据自己的FreeRTOS版本
/**
